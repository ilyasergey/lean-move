      ...
      | some entry =>
        ...
        | (.validVar, .ref τ s isBor, ms) =>
          ...
          · rename_i hfresh
            ...
            · have hpe' := update_with_epsilon_wellformed s t env.pathEnv hwf.pathEnv_wf
          ...
          | trecord fentries =>
            ...
            | some btf =>
              ...
              · rename_i hfresh
                ...
                · have hpe' := update_with_extension_wellformed rf s [.field f] env.pathEnv hwf.pathEnv_wf
