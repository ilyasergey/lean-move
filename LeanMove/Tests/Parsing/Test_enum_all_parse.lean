...
-- Accepted enum tests
private def enum_match_src := include_str "../MVIR/enum_match.mvir"
private def enum_double_unpack_src := include_str "../MVIR/enum_double_unpack.mvir"
private def enum_valid_ref_unpack_src := include_str "../MVIR/enum_valid_ref_unpack.mvir"
private def enum_valid_unpack_loop_src := include_str "../MVIR/enum_valid_unpack_loop.mvir"
private def enum_borrow_field_mutable_src := include_str "../MVIR/enum_borrow_field_mutable.mvir"
private def enum_two_mutable_unpacks_src := include_str "../MVIR/enum_two_mutable_unpacks.mvir"
private def enum_variant_factor_src := include_str "../MVIR/enum_variant_factor.mvir"
private def enum_factor_invalid_src := include_str "../MVIR/enum_factor_invalid.mvir"
private def enum_imm_borrow_on_mut_invalid_src := include_str "../MVIR/enum_imm_borrow_on_mut_invalid.mvir"
private def enum_imm_borrow_on_mut_trivial_invalid_src := include_str "../MVIR/enum_imm_borrow_on_mut_trivial_invalid.mvir"

-- Rejected enum tests
private def enum_borrow_owned_src := include_str "../MVIR/enum_borrow_owned.mvir"
private def enum_invalid_ref_unpack_src := include_str "../MVIR/enum_invalid_ref_unpack.mvir"
private def enum_invalid_ref_unpack_loop_src := include_str "../MVIR/enum_invalid_ref_unpack_loop.mvir"
